...
public final class UMLRTRuntime {
	...
	private static final ExternalHeaderFile umlrtcapsuletocontrollermap_hh = new ExternalHeaderFile("umlrtcapsuletocontrollermap.hh");
	private static final ExternalHeaderFile umlrtsignalregistry_hh = new ExternalHeaderFile("umlrtsignalregistry.hh");
	...
	public static class UMLRTCapsuleToControllerMap {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsuletocontrollermap_hh, "UMLRTCapsuleToControllerMap", "class UMLRTCapsuleToControllerMap");

		public static Type getType() {
			return Element.getType();
		}

		static MemberFunction getControllerNameForCapsuleFunction = new MemberFunction(PrimitiveType.CHAR.constPtr(), "getControllerNameForCapsule");
		static MemberFunction getControllerFromNameFunction = new MemberFunction(UMLRTController.getType().ptr(), "getControllerFromName");

		public static AbstractFunctionCall getControllerForCapsule(Expression capsuleName, Expression capsuleClass) {
			AbstractFunctionCall call = new MemberFunctionCall(Element, getControllerNameForCapsuleFunction);
			call.addArgument(capsuleName);
			call.addArgument(capsuleClass);
			return call;
		}

		public static AbstractFunctionCall getControllerFromName(Expression controllerName) {
			AbstractFunctionCall call = new MemberFunctionCall(Element, getControllerFromNameFunction);
			call.addArgument(controllerName);
			return call;
		}
	}

	public static class UMLRTSignalRegistry {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtsignalregistry_hh, "UMLRTSignalRegistry", "UMLRTSignalRegistry");
