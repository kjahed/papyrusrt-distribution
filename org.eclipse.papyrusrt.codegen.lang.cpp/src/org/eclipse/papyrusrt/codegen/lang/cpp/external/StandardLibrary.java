...
public class StandardLibrary {
	...
	private static final ExternalHeaderFile stdlib_h = new ExternalHeaderFile(true, "stdlib.h");
	...
	private static final Function malloc_f = new Function(stdlib_h, LinkageSpec.EXTERN, PrimitiveType.VOID.ptr(), "malloc");
	private static final Function sizeof_f = new Function(LinkageSpec.EXTERN, size_t, "sizeof");
	...
	public static AbstractFunctionCall malloc(Expression num) {
		return new FunctionCall(malloc_f, num);
	}

	public static AbstractFunctionCall sizeOf(Type type) {
		return new FunctionCall(sizeof_f, new ExpressionBlob(type.toString()));
	}
