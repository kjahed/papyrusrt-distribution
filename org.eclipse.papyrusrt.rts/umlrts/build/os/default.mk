...
CC_OBJS=\
    ...
    $(BUILDROOT)/$(CONFIG)/umlrt/umlrtcommunicator$(OBJ_EXT) \
    $(BUILDROOT)/$(CONFIG)/umlrt/umlrtcontroller$(OBJ_EXT) \
    $(BUILDROOT)/$(CONFIG)/umlrt/umlrtdeploymentmap$(OBJ_EXT) \
    $(BUILDROOT)/$(CONFIG)/umlrt/umlrtexecutiondirector$(OBJ_EXT) \
